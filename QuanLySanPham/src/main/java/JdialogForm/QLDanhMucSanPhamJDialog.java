 ...
 * @author dytc0
 */
public class QLDanhMucSanPhamJDialog extends javax.swing.JDialog {

    IDanhMucSanPhamService _iDanhMucSanPhamService;
    CheckData _check;

    /**
     * Creates new form QLDanhMucSanPhamJDialog
     */
    public QLDanhMucSanPhamJDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QLDanhMucSanPhamJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                QLDanhMucSanPhamJDialog dialog = new QLDanhMucSanPhamJDialog(new javax.swing.JFrame(), true);
